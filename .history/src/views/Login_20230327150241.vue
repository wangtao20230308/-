<template>
  <div>
    <el-form :model="form" :rules="rules" :inline="true" class="login_container" label-width="70px">
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit" style="margin-left: 105px; margin-top: 10px">登录</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
